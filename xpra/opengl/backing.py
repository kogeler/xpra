...
PIXEL_INTERNAL_FORMAT: dict[str, Sequence[IntConstant]] = {
    ...
    "YUV420P10": (GL_R16, GL_R16, GL_R16),
    "YUV422P10": (GL_R16, GL_R16, GL_R16),
...
PIXEL_UPLOAD_FORMAT: dict[str, Sequence[IntConstant] | IntConstant] = {
    ...
    "YUV420P10": (GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT),
    "YUV422P10": (GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT),
...
class GLWindowBackingBase(WindowBackingBase):
    ...
    def do_present_fbo(self, context) -> None:
        ...
        if upscaling and OPENGL_SCALING_FILTER not in ("bilinear", "nearest") and "upscale" in self.programs:
    ...
    def do_paint_rgb(self, context, encoding: str, rgb_format: str, img_data,
        ...
        try:
            ...
            gl_marker("%s update at (%d,%d) size %dx%d (%s bytes) to %dx%d, using GL %s format=%s / %s to internal=%s",
                      ...
                      INTERNAL_FORMAT_TO_STR.get(upload_internal_format))
