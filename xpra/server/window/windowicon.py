    ...
    def send_window_icon(self) -> None:
        ...
        if not icon:
            ...
            if self.has_default:
                ...
                packet = (WINDOW_ICON, self.wid, 0, 0, "default", b"")
